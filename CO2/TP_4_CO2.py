...
def main():
    ...
    m_con_oka = 1.04425682738818
    m_eva_oka = 1.362810871439
    m_con_const = 0.998730848088412
    m_eva_const = 1.362810871439
    ...
    inputs = Inputs(
        ...
        T_eva_in=25.8006104 + 273.15,
        T_con_in=26.9513359 + 273.15,
    ...
    results_path = Path(r"D:\11_Auslegung_CO2\TP_4\AP4\Const_Fix_PL")
