...
def main():
    ...
    m_con_oka = 1.1519965289978
    m_eva_oka = 1.0173824776802
    m_con_const = 1.12043750873967
    m_eva_const = 1.0173824776802
    ...
    results_path = Path(r"D:\11_Auslegung_CO2\TP_5\AP4\Const_Sub_Fix")
