...
def main():
    ...
    m_con_oka = 1.01559762045718
    m_eva_oka = 0.896929351713149
    m_con_const = 1.01559762045718
    m_eva_const = 0.922185499295078
    ...
    inputs = Inputs(
        ...
        T_eva_in=21.8585141 + 273.15,
        T_con_in=18.3384336 + 273.15,
    ...
    results_path = Path(r"D:\11_Auslegung_CO2\TP_5\AP7\Okasha_Sub")
