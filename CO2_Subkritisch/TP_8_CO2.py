...
def main():
    ...
    m_con_oka = 0.980261003927597
    m_eva_oka = 0.838857195603744
    m_con_const = 0.980261003927597
    m_eva_const = 0.876616686762028
    ...
    inputs = Inputs(
        ...
        T_eva_in=9.99034889 + 273.15,
        T_con_in=15.6560167 + 273.15,
    ...
    results_path = Path(r"D:\11_Auslegung_CO2\TP_8\AP7\Okasha_Sub")
