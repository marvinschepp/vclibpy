...
def main():
    ...
    m_con_oka = 1.02054670459611
    m_eva_oka = 1.33207446795182
    m_con_const = 1.02054670459611
    m_eva_const = 1.39257953881901
    ...
    results_path = Path(r"D:\11_Auslegung_CO2\TP_4\AP6\Const")
