...
def main():
    ...
    m_con_oka = 1.01893840012639
    m_eva_oka = 0.900577368865211
    m_con_const = 1.01893840012639
    m_eva_const = 0.93344081292099
    ...
    results_path = Path(r"D:\11_Auslegung_CO2\TP_1\AP4\Okasha_Sub_Fix")
