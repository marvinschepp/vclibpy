...
def main():
    ...
    m_con_oka = 0.97995456466939
    m_eva_oka = 0.836461458107677
    m_con_const = 0.97995456466939
    m_eva_const = 0.876023657568334
    ...
    inputs = Inputs(
        ...
        T_eva_in=8.22012184 + 273.15,
        T_con_in=14.8192239 + 273.15,
    ...
    results_path = Path(r"D:\11_Auslegung_CO2\TP_7\AP7\Okasha_Sub")
