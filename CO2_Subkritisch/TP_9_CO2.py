...
def main():
    ...
    m_con_oka = 0.980594887466479
    m_eva_oka = 0.843640955248468
    m_con_const = 0.980594887466479
    m_eva_const = 0.877877519198564
    ...
    results_path = Path(r"D:\11_Auslegung_CO2\TP_9\AP7\Const_Sub")
