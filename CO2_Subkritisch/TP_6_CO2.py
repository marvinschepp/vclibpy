...
def main():
    ...
    m_con_oka = 0.979652652734695
    m_eva_oka = 0.834014493743203
    m_con_const = 0.979652652734695
    m_eva_const = 0.875498706834341
    ...
    inputs = Inputs(
        ...
        T_eva_in=6.49503267 + 273.15,
        T_con_in=13.9522346 + 273.15,
    ...
    results_path = Path(r"D:\11_Auslegung_CO2\TP_6\AP4\Okasha_Fix")
