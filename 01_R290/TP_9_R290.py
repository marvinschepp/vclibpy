...
def main():
    ...
    m_con_guth = 0.980593050869373
    m_eva_guth = 0.953267522543893
    m_con_const = 0.980593108089269
    m_eva_const = 0.923593030420099
    ...
    inputs = Inputs(
        ...
        T_eva_in=11.8041499 + 273.15,#10 + 273.15,
        T_con_in=16.524669 + 273.15,#25 + 273.15,
    ...
    results_path = Path(r"D:\12_Auslegung_R290\TP_9\AP4\Guth_Fix")
