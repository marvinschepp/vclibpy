...
def main():
    ...
    m_con_guth = 0.980258750231366
    m_eva_guth = 0.95843784847542
    m_con_const = 0.98025882539998
    m_eva_const = 0.926504206156643
    ...
    inputs = Inputs(
        ...
        T_eva_in=9.99034889 + 273.15,#10 + 273.15,
        T_con_in=15.6560167 + 273.15,#25 + 273.15,
    ...
    results_path = Path(r"D:\12_Auslegung_R290\TP_8\AP4\Const_Neu")
