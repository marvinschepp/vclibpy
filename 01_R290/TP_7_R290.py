...
def main():
    ...
    m_con_guth = 0.979951917191337
    m_eva_guth = 0.961485070511107
    m_con_const = 0.979952004036553
    m_eva_const = 0.929985267617152
    ...
    inputs = Inputs(
        ...
        T_eva_in=8.22012184 + 273.15,#10 + 273.15,
        T_con_in=14.8192239 + 273.15,#25 + 273.15,
    ...
    results_path = Path(r"D:\12_Auslegung_R290\TP_7\AP4\Const_Neu")
