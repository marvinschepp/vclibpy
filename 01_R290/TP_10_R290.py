...
def main():
    ...
    m_con_guth = 0.981027147929858
    m_eva_guth = 0.946123009040179
    m_con_const = 0.981027185872875
    m_eva_const = 0.920011419712005
    ...
    inputs = Inputs(
        ...
        T_eva_in=14.0322332 + 273.15,#10 + 273.15,
        T_con_in=17.5941378 + 273.15,#25 + 273.15,
    ...
    results_path = Path(r"D:\12_Auslegung_R290\TP_10\AP6\Const_Fix")
