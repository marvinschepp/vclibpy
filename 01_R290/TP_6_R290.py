...
def main():
    ...
    m_con_guth = 0.979649619817592
    m_eva_guth = 0.962817947679606
    m_con_const = 0.979649724363998
    m_eva_const = 0.931792978990447
    ...
    results_path = Path(r"D:\12_Auslegung_R290\TP_6\AP4\Const_Neu")
