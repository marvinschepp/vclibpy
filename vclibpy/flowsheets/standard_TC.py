...
class TCStandardCycle(BaseCycle):
    """
    Class for a transcritical standard cycle with four components.
    ...
    flowsheet_name = "Standard TC"                                  #Definition of a class parameter describing the flowsheet type
