...
from vclibpy.flowsheets import BaseCycleTC, StandardCycleTC, StandardCycle, BaseCycle
import numpy as np
import pandas as pd
...
def main():
    ...
    condenser = mvb_new.GasCooler(
        A=46.3139073313253,#0.986125012,
    ...
    from vclibpy.components.compressors import ConstantEffectivenessCompressor, Guth_R290_Scroll
    compressor = Guth_R290_Scroll(
        N_max=50,
        V_h=1.912742046112e-5,
        eta_mech=1.0,
    )
    ...
    inputs = Inputs(
        ...
        T_con_in=35.9513359 + 273.15,#25 + 273.15,
        dT_eva_superheating=10,
        dT_con_subcooling=0,
        m_flow_eva=1.33173444849021,
    ...
    results_path = Path(r"D:\01_Alpha_Study\CO2")
