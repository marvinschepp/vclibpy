...
# --- PFADE ANPASSEN ---
input_file = Path(r"D:\11_Auslegung_CO2\TP_1\R744.csv")
...
try:
    ...
    # --- 1. ECKPUNKTE ANHAND DEINER ZEILENNUMMERN AUS DEM ORIGINAL-DF AUSWÄHLEN ---
    # Pandas' iloc zählt ab 0. Die erste Datenzeile nach dem Header ist iloc[0].
    # CSV Zeile 4  -> iloc[2]
    # CSV Zeile 5  -> iloc[3]
    # CSV Zeile 54 -> iloc[52]
    # CSV Zeile 55 -> iloc[53]
    ...
    df_cycle_corners = pd.DataFrame([
        ...
        df.iloc[3],  # ZP 2 (deine Zeile 5)
        df.iloc[52],  # ZP 3 (deine Zeile 54)
        df.iloc[53]  # ZP 4 (deine Zeile 55)
    ])
